const prompt = (options) => {
  ...
  return `
    Eres un desarrollador en busca de empleo. Construye 3 opciones de mensaje personal en ${options.lang} para enviar via linkedIn, no más de 400 caracteres cada opción, dirigido a ${options.receiver}, de ${options.company}. 
    
    ${project}

    Menciona tu experiencia en ${options.skills_tech} y como  podría ser de utilidad para la empresa y sus proyectos. Y como tu ${options.skills_soft} se relaciona con ${options.values} que tiene su empresa.
